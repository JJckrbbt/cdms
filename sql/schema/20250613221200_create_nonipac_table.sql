...
CREATE TABLE "nonIpac" (
    ...
    "address_code" VARCHAR(8) NOT NULL, -- Foreign key will be added in a later migration
    ...
    "pfs_poc" UUID, -- Foreign key will be added in a later migration
    "gsa_poc" UUID, -- Foreign key will be added in a later migration
